...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="pagina/css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="pagina/css/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="pagina/css/responsive.css">
      <!-- fevicon -->
      <link rel="icon" href="pagina/images/fevicon.png" type="pagina/image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="pagina/css/jquery.mCustomScrollbar.min.css">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="pagina/images/loading.gif" alt="#"/></div>
      </div>
      <!-- end loader -->
               ...
               <div class="row d_flex">
                  <div class=" col-md-2 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="/landingpage"><img src="pagina/images/logo.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-10 col-sm-9">
                     <ul class="site_menu text_align_right">
                        <li >
                           <button class="openbtn" onclick="openNav()"><img src="pagina/images/menu_icon.png"></button>
                        </li>
                     </ul>
                  </div>
               </div>
                              ...
                              <div class="col-md-8">
                                 <div class="build_box text_align_left">
                                    ...
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,
                                       I am Micheal Klinton and today I will present you the metal products that you can find without problems
                                    </p>
         ...
         <div class="bg_about">
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-5">
                     <div class="about_img">
                        <figure><img src="pagina/images/about.jpg" alt="#"/></figure>
                     </div>
                  </div>
                           ...
                           <div class="row d_flex">
                              <div class="col-md-4">
                                 <div class="product mar_bottom30">
                                    <figure><img src="pagina/images/pro1.png" alt="#"/></figure>
                                    <h3>distribution</h3>
                                 </div>
                              </div>
                              <div class="col-md-4 mar_bottom30">
                                 <div class="product">
                                    <figure><img src="pagina/images/pro2.png" alt="#"/></figure>
                                    <h3>distribution</h3>
                                 </div>
                              </div>
                              <div class="col-md-4">
      ...
      <!-- end footer -->
      <!-- Javascript files-->
      <script src="pagina/js/jquery.min.js"></script>
      <script src="pagina/js/bootstrap.bundle.min.js"></script>
      <script src="pagina/js/jquery-3.0.0.min.js"></script>
      <!-- sidebar -->
      <script src="pagina/js/jquery.mCustomScrollbar.concat.min.js"></script>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.8.1/baguetteBox.min.js"></script>
      <script src="pagina/js/custom.js"></script>
   </body>
</html>